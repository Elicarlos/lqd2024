...
class Cupom(models.Model):
    ...
    posto_trabalho = models.ForeignKey(PostoTrabalho, on_delete=models.SET_NULL, null=True, blank=True)
    # operador = CurrentUserField(verbose_name=u'Cadastrado Por', related_name='rel_cupom_operador', editable=False)
    operador = CurrentUserField(verbose_name=u'Cadastrado Por', related_name='rel_cupom_operador', null=True)
